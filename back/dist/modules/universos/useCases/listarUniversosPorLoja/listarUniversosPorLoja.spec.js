...
var ListarUniversosPorLojaUsecase = class {
  constructor(universosRepository2, lojasRepository2) {
    this.universosRepository = universosRepository2;
    this.lojasRepository = lojasRepository2;
  }
  async execute(nome) {
...
// src/modules/universos/useCases/listarUniversosPorLoja/listarUniversosPorLoja.spec.ts
var universosRepository;
var lojasRepository;
var criarUniversoUseCae;
var sut;
describe("Criar Loja Usecase", () => {
  ...
  it("Deve listar os universos de uma loja", async () => {
    ...
    globalExpect(universos.length).greaterThan(0);
  });
  it("Deve retornar um erro caso a loja n\xE3o exista", async () => {
    await criarUniversoUseCae.execute({
      Andar: "0",
      Zona: "0",
      Loja_Sigla: "l-sigla",
