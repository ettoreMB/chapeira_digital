...
var DeletarUniversoUsecase = class {
  constructor(universoRepository, colaboradoresRepository2) {
...
// src/modules/universos/useCases/deletarUniverso/deletarUniversoUsecase.spec.ts
...
describe("Criar Loja Usecase", () => {
  ...
  it("Deve deletar um universo", async () => {
    ...
    globalExpect(await universosRepository.buscarPorId(Id)).toBe(null);
  });
  it("Nao Deve ser possivel deletar um universo de  nao registrado", async () => {
    ...
    await globalExpect(sut.execute(Id + 2)).rejects.toBeInstanceOf(AppErrors);
  });
