...
var EditarUniversoUsecase = class {
  constructor(universosRepository2) {
...
// src/modules/universos/useCases/editarUniverso/test/editar-universo-usecase.spec.ts
...
describe("Editar Universo Usecase", () => {
  ...
  it("Deve editar um universo", async () => {
    ...
    globalExpect(universo.Zona).toBe("1");
    globalExpect(universo.Andar).toBe("1");
    globalExpect(universo.Universo).toBe("universoTeste");
  });
  it("N\xE3o Deve editar um universo n\xE3o existente", async () => {
    globalExpect(
      () => sut.execute({
        Andar: "1",
        Universo: "universoTeste",
