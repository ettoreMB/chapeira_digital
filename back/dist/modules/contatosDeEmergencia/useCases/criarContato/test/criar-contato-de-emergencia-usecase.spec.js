...
// src/modules/contatosDeEmergencia/useCases/criarContato/test/criar-contato-de-emergencia-usecase.spec.ts
...
describe("Criar Contato de Emergecia Usecase", () => {
  ...
  it("Deve Criar um contato de emergencia", async () => {
    ...
    globalExpect(contato.Id).toEqual(globalExpect.any(Number));
  });
});
