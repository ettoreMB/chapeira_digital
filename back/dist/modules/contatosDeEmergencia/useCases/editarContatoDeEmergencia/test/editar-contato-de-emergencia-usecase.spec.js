...
// src/modules/contatosDeEmergencia/useCases/editarContatoDeEmergencia/test/editar-contato-de-emergencia-usecase.spec.ts
var contatoDeEmergenciaRepository;
var sut;
describe("Criar Contato de Emergecia Usecase", () => {
  ...
  it("Deve Editar um contato de emergencia", async () => {
    ...
    globalExpect(contato.Contato).toEqual("nome");
  });
  it("N\xE3o Deve Editar um contato de n\xE3o existente", async () => {
    await globalExpect(
      () => sut.execute({
        id: 1,
        descricao: "",
