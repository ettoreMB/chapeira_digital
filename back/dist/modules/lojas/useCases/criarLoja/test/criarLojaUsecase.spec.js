...
var UniversosRepositoryInMemory = class {
  ...
  async criar(data) {
    const universo = {
      ...
      Id_Key: (0, import_crypto2.randomUUID)(),
      Loja_Sigla: data.Loja_Sigla,
      Zona: data.Zona,
      Andar: data.Andar,
  ...
  async buscarUniversosPorLoja(sigla2) {
    const universos = this.items.filter(
      (universo) => universo.Loja_Sigla === sigla2
    );
    return universos;
  }
...
var string = (str) => String(str);
string.open = "";
string.close = "";
var defaultColors = colorsEntries.reduce((acc, [key]) => {
  acc[key] = string;
  return acc;
...
// node_modules/vitest/dist/chunk-utils-global.727b6d25.js
...
function sliceAnsi(string3, begin, end) {
  ...
  for (const [index2, character] of characters.entries()) {
    ...
    if (ESCAPES.includes(character)) {
      const code = /\d[^m]*/.exec(string3.slice(index2, index2 + 18));
...
function getIndexOfNearestSpace(string3, wantedIndex, shouldSearchRight) {
  ...
  for (let index2 = 1; index2 <= 3; index2++) {
    if (shouldSearchRight) {
      if (string3.charAt(wantedIndex + index2) === " ") {
        return wantedIndex + index2;
      }
    } else if (string3.charAt(wantedIndex - index2) === " ") {
      return wantedIndex - index2;
    }
  }
  return wantedIndex;
...
// node_modules/vitest/dist/chunk-runtime-rpc.1232904e.js
var { get: get2 } = Reflect;
var safeRandom = Math.random;
function withSafeTimers(fn2) {
  const { setTimeout: setTimeout2, clearTimeout, nextTick, setImmediate, clearImmediate } = getSafeTimers();
...
var rpc = () => {
  ...
  return new Proxy(rpc2, {
    get(target, p, handler) {
      const sendCall = get2(target, p, handler);
...
// node_modules/vitest/dist/chunk-utils-base.81f83dbd.js
...
// node_modules/vitest/dist/chunk-utils-tasks.b41c8284.js
...
// node_modules/vitest/dist/chunk-utils-import.8bd22905.js
...
async function waitForImportsToResolve() {
  ...
  if (!promises2.length && !resolvingCount)
    return;
...
var writeSnapshotVersion = () => `// Vitest Snapshot v${SNAPSHOT_VERSION}, https://vitest.dev/guide/snapshot.html`;
...
var addExtraLineBreaks = (string3) => string3.includes("\n") ? `
${string3}
` : string3;
var removeExtraLineBreaks = (string3) => string3.length > 2 && string3.startsWith("\n") && string3.endsWith("\n") ? string3.slice(1, -1) : string3;
...
// node_modules/vitest/dist/chunk-integrations-run-once.9012f759.js
...
// node_modules/vitest/dist/chunk-integrations-utils.5243a0d7.js
...
var CriarLojaUsecase = class {
  constructor(lojasRepository, cidadesRepository2, colaboradorRepository2, universosRepository2) {
    this.lojasRepository = lojasRepository;
    this.cidadesRepository = cidadesRepository2;
    this.colaboradorRepository = colaboradorRepository2;
    this.universosRepository = universosRepository2;
  }
  async execute(data) {
...
// src/modules/lojas/useCases/criarLoja/test/criarLojaUsecase.spec.ts
var lojaRepository;
var cidadesRepository;
var universosRepository;
var colaboradorRepository;
var criarLojaUseCase;
var sigla = "siglaTeste";
describe("Criar Loja Usecase", () => {
  ...
  it("Deve Criar uma loja", async () => {
    ...
    globalExpect(loja.URL).toEqual(globalExpect.any(String));
  });
  it("N\xE3o deve criar uma loja com CNPJ j\xE1 cadastrado", async () => {
  ...
  it("N\xE3o deve criar uma loja com a sigla j\xE1 cadastrada", async () => {
    globalExpect(async () => {
      await criarLojaUseCase.execute({
        CNPJ: 123456781,
        Loja: "loja-teste",
...
vitest/dist/chunk-utils-import.8bd22905.js:
  (*
   * @version    1.4.0
   * @date       2015-10-26
   * @stability  3 - Stable
