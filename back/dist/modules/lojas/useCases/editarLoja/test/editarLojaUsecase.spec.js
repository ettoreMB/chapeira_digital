...
var EditarLojaUsecase = class {
  constructor(lojaRepository2) {
    this.lojaRepository = lojaRepository2;
  }
...
// src/modules/lojas/useCases/editarLoja/test/editarLojaUsecase.spec.ts
var lojaRepository;
var sut;
var sigla = "sigla-teste";
describe("Editar loja", () => {
  ...
  it("Deve editar as informa\xE7\xF5es da loja", async () => {
    const loja = await sut.execute(sigla, {
      Loja_Endereco: "novo_endereco",
      Loja_Horario: "12 as 13",
      Loja_Telefone: "1234456"
    });
    globalExpect(loja.Loja_Telefone).toBe("1234456");
    globalExpect(loja.Loja_Endereco).toBe("novo_endereco");
  });
  it("N\xE3o deve encontrar uma loja nao cadastrada", async () => {
