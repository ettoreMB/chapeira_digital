...
// src/modules/colaboradores/useCases/criarColaborador/test/criar-colaborador-usecase.spec.ts
...
describe("Criar Colaborador Usecase", () => {
  ...
  it("Deve Criar um colaborador", async () => {
    ...
    globalExpect(colaborador.Id).toEqual(globalExpect.any(Number));
  });
  it("N\xE3o Deve Criar um colaborador com email j\xE1 existente na loja", async () => {
    await sut.execute({
      Administrador: "Nao",
      Brigadista: "Nao",
      Email: "teste@teste",
