...
var CadastrarNovaSenhaUseCase = class {
  constructor(colaboradoresRepository2, lojaRepository) {
    this.colaboradoresRepository = colaboradoresRepository2;
...
var import_runtime2 = require("@prisma/client/runtime");
var LojasRepositoryInMemory = class {
  ...
  async criar(data) {
    const loja = {
      ...
      CNPJ: data.CNPJ,
      Inscricao_Estadual: "",
      Tablets: new import_runtime2.Decimal(2),
...
// src/modules/colaboradores/useCases/cadastrarNovaSenha/test/cadastrarNovaSenha-usecase.spec.ts
var import_fast_jwt2 = require("fast-jwt");
...
describe("Cadastrar nova senha Usecase", () => {
  ...
  it("Deve Trocar a senha", async () => {
    ...
    const signSync = (0, import_fast_jwt2.createSigner)({ key: "secret" });
    const token = signSync({ sub: "teste@teste", b: 2, c: 3 });
    await sut.execute(token, "chapeira", "lojateste");
    globalExpect(colaborador.Senha).toEqual("chapeira");
  });
});
