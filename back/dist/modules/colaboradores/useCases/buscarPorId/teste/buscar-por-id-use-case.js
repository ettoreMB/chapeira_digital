...
// src/modules/colaboradores/useCases/buscarPorId/teste/buscar-por-id-use-case.ts
...
describe("Buscar por id", () => {
  ...
  it("Deve acahr um colaborador", async () => {
    ...
    await globalExpect(() => sut.execute(Id)).toMatchObject({
      Email: "teste@test"
    });
  });
  it("N\xE3o Deve acahr um colaborador", async () => {
    await globalExpect(() => sut.execute(1)).rejects.toBeInstanceOf(AppErrors);
  });
});
