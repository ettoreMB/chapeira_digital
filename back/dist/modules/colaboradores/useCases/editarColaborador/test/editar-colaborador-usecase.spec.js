...
// src/modules/colaboradores/useCases/editarColaborador/test/editar-colaborador-usecase.spec.ts
...
describe("Editar Colaborador Usecase", () => {
  ...
  it("Deve Editar um colaborador", async () => {
    ...
    globalExpect(colaborador.Email).toEqual("teste@teste.com");
  });
  it("N\xE3o Deve Editar um colaborador inexistente", async () => {
    await globalExpect(
      () => sut.execute({
        id: 2,
        admin: "Nao",
